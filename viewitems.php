<?php
            ...
            head(); //loads head of html file
            nav(); //loads nav bar
            cara();//loads carasel object
            items(); //loads the items
            auctions();//loads auction list
            ending(); //loads rest of page

        function head(){ //careates head tag
            echo "<!DOCTYPE html>
            <html>
        ...
        function cara(){//loads carosel object
        ...
        function items(){//loads the auction items
            ...
            $result = $con->query("SELECT * FROM `auctionItem` WHERE `houseKey` = 1 "); //returns a set of the items
          
            while($row = $result->fetch_row()){//get the query 
                echo '<div class="w3-third">
                        <p> Name: $'.$row[2].'</p>
                        <p> Start Bid: $'.$row[4].'</p>
                        <p> Description: '.$row[3].'</p>
                        <a onclick="document.getElementById("itemModal").style.display="block"">
                        <img src="/img/item.gif" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
                        </a>
                </div>';
        ...
        function auctions(){//generates auction list
    ...
    <div id="AuctionModal" class="w3-modal">
        ...
        <span onclick="document.getElementById("itemsModal").style.display="none""
            ...
            <div class="w3-container">
                ...
                <input name="charity" class="w3-input w3-border" type="text" placeholder="Charity Name">
